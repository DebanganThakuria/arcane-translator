...
#
#   brew install <user>/tap/arcane-translator
#
# Before the first release: create a GitHub release tagged v1.0.0, then fill in
# `sha256` with the output of
#
#   curl -sL https://github.com/<user>/arcane-translator/archive/refs/tags/v1.0.0.tar.gz | shasum -a 256
class ArcaneTranslator < Formula
  ...
  license "Apache-2.0"
  head "https://github.com/debanganthakuria/arcane-translator.git", branch: "main"
